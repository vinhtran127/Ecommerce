...
public class searchProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List< product> listP = new productDAO().search6Product(index, txtSearch);
        List<category> listC = new categoryDAO().getAllCategory();
        int countP = new productDAO().countProductSearched(txtSearch);
        ...
        session.setAttribute("servs", "searchProduct");
