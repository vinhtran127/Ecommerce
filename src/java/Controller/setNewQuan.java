 ...
 * @author vinh2
 */
@WebServlet(name = "setNewQuan", urlPatterns = {"/setNewQuan"})
public class setNewQuan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        new DAO.cartDAO().updateQuantity(accID, productID, newQuan, size);
        ...
        for (cart c : listCart) {
            s += "                                <tr>\n"
                    ...
                    + "                                    </td>\n"
                    + "                                    <td class=\"cart_img\">\n"
                    + "                                        <a href=\"\"><img width=\"120px\" src=\"" + c.getImgLink() + "\" alt=\"\"></a>\n"
                    + "                                    </td>\n"
                    + "                                    <td class =\"cart_size\">\n"
                    ...
                    + "                                        <a onclick=\"remove(" + c.getProductID() + "," + c.getSize() + ")\" class=\"btn cart_quantity_delete\"><i class=\"fa fa-times\"></i></a>\n"
                    + "                                    </td>\n"
                    + "                                </tr>";
        }
